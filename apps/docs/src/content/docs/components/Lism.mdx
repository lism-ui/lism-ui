...
<Reference>
[指定可能なCSS Props一覧はこちら](/components/props/css-props/)
</Reference>
...
<Reference>
[ブレイクポイントで値を切り替える書き方はこちらのページで解説しています](/components/props/responsive-props/)
</Reference>
...
[`pass-get`](/css/pass-get) に関するプロパティとして、以下ものを受け取れるようになっています。
