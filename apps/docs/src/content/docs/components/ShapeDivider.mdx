...
## Import
<ImportSource name='ShapeDivider' css='scss' react astro/>
...
<Preview>
	...
	<PreviewArea resize p='5' isFlow={false}>
		...
		<Box pos='r'>
			<ShapeDivider viewBox='0 0 10 10' level='6' scale='-XY' offsetY='-0.5px'>
				<path d="M10,10V0L0,9.5V10L10,10z"/>
			</ShapeDivider>
			<Box hasGutter py='50'>
				<Dummy length='l' />
			</Box>
			<ShapeDivider viewBox='0 0 10 10' level='6' offsetY='0.5px'>
				<path d="M10,10V0L0,9.5V10L10,10z"/>
			</ShapeDivider>
		</Box>
		<Box hasGutter py='50' bgc='text' c='base'>
...
<Preview>
	...
	<PreviewArea resize p='5' isFlow={false}>
		<Box pos='r' hasGutter>
			...
			<ShapeDivider viewBox='0 0 100 10' isAnimation c='base' level='6' offsetY='0.5px'>
...
<Preview>
	...
	<PreviewArea resize p='5' isFlow={false}>
		...
		<Box pos='r' hasGutter>
			<ShapeDivider viewBox='0 0 100 10' c='base' scale='-Y' level='8' stretch={1.1} offsetX='-5%' offsetY='-0.5px'>
			...
			<ShapeDivider viewBox='0 0 100 10' c='base' level='8' stretch={1.1} offsetY='0.5px'>
				<path d="M100 6C89.3 3.3 82.7 9 70 9S48.4 3 38 3 24.5 6 17 6C7.4 6 0 0 0 0v10h100V6z"/>
			</ShapeDivider>
		</Box>
		<Box hasGutter py='40'>
