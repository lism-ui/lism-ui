...
import { Lism, Container, Stack, Text, Columns, Spacer } from  '@lism-ui/astro';
...
<Container isFlow hasGutter>
	...
	<Spacer h='40' />
	<Button variant='fill' mx='auto' href='ja/overview/' bdrs='99'>ドキュメントを読む</Button>
