...
import { Divider, Stack, Text, Center, Flex, Icon, Dummy } from '@lism-ui/core';
...
import { Minus, Plus, X, Question, CaretDown, EyeClosed, Eyes } from "@phosphor-icons/react";
...
<ImportPackage component='Accordion, AccordionHeader, AccordionBody' />
...
<Preview>
	...
	<PreviewArea p={30}>
		<AccordionGroup g='20'>
			<Accordion bgc='base-2' bxsh='1' bdrs='3'>
