...
| プロパティ | 説明 | 
|---|---|
| <PropBadge>`<Accordions>`</PropBadge><br/>`variant` | <PropBadge type="attr">`.d--accordions--{variant}`</PropBadge> バリエーションクラスを出力します |
| <PropBadge>`<Accordion.Root>`</PropBadge><br/>`variant` | <PropBadge type="attr">`.d--accordion--{variant}`</PropBadge> バリエーションクラスを出力します |
