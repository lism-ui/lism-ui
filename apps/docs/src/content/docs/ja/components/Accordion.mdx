...
複数の`<Accordion.Root>`(`.d--accordion`)を含む親要素に `[data-acc-multiple="disallow"]`を指定すると、複数のアコーディオンを同時に開くことを禁止し、どれかが開くとその兄弟アコーディオンを閉じるようになります。

<Preview>
	<PreviewTitle>Preview</PreviewTitle>
	<PreviewArea p={30}>
		<Stack g='1px' data-acc-multiple='disallow'>
			<Accordion.Root>
	...
	<PreviewCode slot='tab' label='JSX'>
```jsx "data-acc-multiple='disallow'"
<Stack g='1px' data-acc-multiple='disallow'>
	<Accordion.Root>
		<Accordion.Header p='30' bgc='text' c='base'>
			<Accordion.Label>Accordion.Label</Accordion.Label>
...
<div class="l--stack" data-acc-multiple="disallow">
