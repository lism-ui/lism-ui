...
| プロパティ | 出力 | 説明 | 
|---|---|---|
| <PropBadge>`<Accordion>`</PropBadge>,<PropBadge>`<AccordionGroup>`</PropBadge><br/>`duration` | <PropBadge type="cssvar">`--acc-trsdu`</PropBadge> | 開閉アニメーションの時間を指定できます。 |
...
<div class="c--accordionGroup l--stack has--divider -bd:" data-acc-multiple="disallow">
	...
</div>
```
	</PreviewCode>
...
<details class="c--accordion">
	...
	<div class="c--accordion__body l--grid">
