...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="c--callout l--withSide u--colored -p:20 -bd: -bdrs:2 -g:20" style="--keycolor:var(--red)">
			<div class="c--callout__icon l--center -c:keycolor -fz:xl -p:5" data-is-side>
