...
| プロパティ | 説明 |
|---|---|
|`icon`| アイコンを指定できます。デフォルトは `"lism:alert"`です。|
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="c--callout l--sideFlex -boxcolor:red" data-side="first">
			<div class="c--callout__icon l--center -c:boxcolor -fz:xl">
...
<Preview>
	...
	<PreviewArea p='30'>
		<Callout icon='lism:good' boxcolor='green'>
			<DammyText lang='ja' length='codes' />
		</Callout>
		<Callout icon='lism:bad' boxcolor='blue'>
			<DammyText lang='ja' length='codes' />
		</Callout>
		<Callout icon='lism:book-open' boxcolor='#185b6e'>
			Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo sunt deserunt
		</Callout>
	</PreviewArea>
	<PreviewCode slot='tab' label='Component'>
	```jsx
	<Callout icon='lism:good' boxcolor='green'>...</Callout>
	<Callout icon='lism:bad' boxcolor='blue'>...</Callout>
	```
	</PreviewCode>
</Preview>
