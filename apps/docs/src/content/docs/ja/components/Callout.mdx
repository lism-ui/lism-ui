...
import { Callout } from '~/components/ex/Callout';
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="c--callout l--withSide is--colored -p:20 -bd: -bdrs:2 -g:20" style="--keycolor:var(--red)">
			<div class="c--callout__icon l--center is--side -c:keycolor -fz:xl -p:5">
...
<OptinHelp />
<ImportSource react='Callout/index.jsx' astro='/Callout/index.astro' />
