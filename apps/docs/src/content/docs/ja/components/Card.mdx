...
<Preview>
	<PreviewTitle>`sidePosition`（`<WithSide>`で使用できるプロパティ）を指定して並びをブレイクポイントで切り替える</PreviewTitle>
	<PreviewArea resize p='30'>
		<Card sideW='50%' sidePosition='start start'>
			<Frame isSide ar={['16/9','4/3']} w='100%' h='100%'>
				<Media src='/img/img-1.jpg' alt='' width='960' height='640' />
			</Frame>
			<Stack g='10' p='30'>
				<h3 className='-fz:l'>Card Title</h3>
...
`<Card>`に`href`を指定すると、`isLinkBox tag='a'` が適用され、カード全体を[`is--linkBox`](/ja/components/linkbox/)でリンク化します。
...
リンク要素を一部の要素に限定したい場合や、カード全体をリンクにしつつ、別のリンクを含めたい場合、 `u--overlayLink` か `u--hiddenLink` を使用してください。

<Preview>
	<PreviewTitle>`u--overlayLink`を使う例</PreviewTitle>
	<PreviewArea resize p='40'>
		<Card isLinkBox hov={{bxsh: '4'}} trs sideW='50%'>
			<Frame isSide ar='4/3' pos='r'>
				<Media src='/img/img-1.jpg' alt='' width='960' height='640' />
...
<Preview>
	...
	<PreviewArea resize p='30'>
		<Card sideW='45%' g='20' p='20' bdrs='4'>
			<Frame isSide ar='16/9' bdrs='inner'>
				<Media src='/img/img-1.jpg' alt='' width='960' height='640' />
			</Frame>
			<Stack g='10' p='10'>
				<h3 className='-fz:l'>Card Title</h3>
...
<Preview>
	...
	<PreviewArea p='30'>
		<Columns variant='liquid' colSize='20rem' g='30'>
			<Card href='#card-a' pos='r' bdrs='3' hov='pass'>
				<Frame ar='4/3'>
					<img src='/img/img-1.jpg' alt='' width='960' height='640' />
				</Frame>
			...
			<Card href='#card-b' pos='r' bdrs='3' hov='pass'>
				<Frame ar='4/3'>
	...
	```jsx
	<Columns variant='liquid' colSize='20rem' g='30'>
		<Card href='#card-a' pos='r' bdrs='2' hov='pass'>
			<Frame ar='4/3'>
				<img src='/img/img-1.jpg' alt='' width='960' height='640' />
			</Frame>
			<Stack pos='a' b='0' w='100%' p='20' bgc='white:50%'>
		...
		<Card href='#card-b' pos='r' bdrs='2' hov='pass'>
			<Frame ar='4/3'>
				<img src='/img/img-2.jpg' alt='' width='960' height='640' />
			</Frame>
			<Stack pos='a' b='0' w='100%' p='20' bgc='white:50%'>
...
<Preview>
	...
	<PreviewArea resize p='30'>
		<Card sideW='50%' sidePosition='start start' bxsh='0' bdrs='0'>
			<Frame isSide ar={['16/9', 'unset']} pos='r' bdrs='3'>
	...
	<PreviewCode slot='tab' label='JSX'>
		...
		<Card sideW='50%' sidePosition='start start' bxsh='0' bdrs='0'>
			<Frame isSide ar={['16/9', 'unset']} pos='r'>
				<Media pos='a' src='/img/img-1.jpg' alt='' width='960' height='640' />
			</Frame>
			<Stack g='10' p='30'>
				<h3 className='-fz:l'>Card Title</h3>
