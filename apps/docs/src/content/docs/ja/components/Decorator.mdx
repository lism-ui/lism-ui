...
<Preview>
	...
	```jsx
	<div class="l--grid">
		<div class="l--decorator -bd:l -trfo:lb -rotate:45 -ar:1/1 -w:" style="--w:1.25em" aria-hidden="true"></div>
		...
		<div class="l--decorator -bd:l -trfo:lt -rotate:-45 -ar:1/1 -w:" style="--w:1.25em" aria-hidden="true">    </div>
	</div>
	```
	</PreviewCode>
</Preview>
