...
<Preview>
	...
	<PreviewArea resize>
		<Frame tag='figure' aspect='2/1'>
			<img src='/img/img-1.jpg' alt='' width='960' height='640' />
			<figcaption className='-pos:a -b:0 -w:100 -ta:c -bgc:' style={{'--bgc':'hsl(var(--hsl-white) / 50%)'}}>An elephant at sunset</figcaption>
		</Frame>
	</PreviewArea>
	<PreviewCode slot='tab' label='JSX'>
		```jsx
		<Frame tag='figure' aspect='2/1'>
			<img src='/img/img-1.jpg' alt='' width='960' height='640' />
			<figcaption className='-pos:a -b:0 -w:100 -ta:c -bgc:' style={{'--bgc':'hsl(var(--hsl-white) / 50%)'}}>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<figure class="is--frame -aspect:2/1">
			<img src='/img/img-1.jpg' alt='' width='960' height='640' />
			<figcaption className='-pos:a -b:0 -w:100 -ta:c -bgc:' style={{'--bgc':'hsl(var(--hsl-white) / 50%)'}}>
				An elephant at sunset
			</figcaption>
