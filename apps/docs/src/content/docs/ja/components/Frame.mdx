...
<Preview>
	<PreviewTitle>`aspect='2/1'`を指定</PreviewTitle>
	<PreviewArea resize>
		<Frame aspect='2/1'>
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<figure class="l--frame -aspect:16/9">
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Frame aspect='16/9' pos='r' c='white'>
			<img src='/img/img-1.jpg' alt='' width='960' height='640' />
	...
	<PreviewCode slot='tab' label='JSX'>
		...
		<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="l--frame -aspect:16/9 -pos:r -c:white">
			<img src="/img/img-1.jpg" alt="" width="960" height="640">
	...
	return (
		<Columns cols={[1, 2]} g={20} >
			{['gold', 'silver', 'bronze', 'ogp'].map((ratio) => {
				return (
					<Frame key={ratio} aspect={ratio} pos='r' bgc='base-2'>
...
<Preview>
	<PreviewTitle>`aspect`にそれぞれ指定</PreviewTitle>
	<PreviewArea p={20}>
		<FrameRatios />
	</PreviewArea>
	<PreviewCode>
...
<Preview>
	<PreviewTitle>Boxにaspectを指定する例</PreviewTitle>
...
<Preview>
	<PreviewTitle>`aspect`はブレイクポイントで変更することも可能です。</PreviewTitle>
	<PreviewArea resize p='20'>
		<Frame aspect={['1/1', '4/3', '16/9']} pos='r'>
			<img src='/img/img-1.jpg' alt='' width='960' height='640' />
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div
			class="l--frame -aspect:1/1 -pos:r -aspect@sm -aspect@md"
