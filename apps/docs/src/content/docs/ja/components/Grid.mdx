...
<Preview>
	...
	<PreviewArea resize p='20'>
		<Grid gtc='a1a' g='20'>
			...
			<Center p='30' bgc='base-2'>Center</Center>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="l--grid -gtc:a1a -g:20">
			<div class="l--center -p:30 -bgc:base-2">L</div>
			<div class="l--center -p:30 -bgc:base-2">Center</div>
...
<Preview>
	...
	<PreviewArea resize p='20'>
		<Grid variant='repeat' cols='3' g='20'>
			...
			<GridItem p='20' bgc='base-2' gc='span 2'><DammyText /></GridItem>
			<GridItem p='20' bgc='base-2' gc='span 2'><DammyText length='l'/></GridItem>
