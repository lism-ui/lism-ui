...
import { Spacer, Box, Grid, Media, Dummy, Text, Container, Layer, Stack, FlexItem, Center, Frame, Button, ShapeDivider } from '@lism-ui/astro';
...
<Preview>
	...
	<PreviewArea resize>
		<Stack isFullwide minH='50vh' bgc='base-2'>
			<ShapeDivider shape='wave2' c='base' isFlip />
			<Container size='m' hasGutter isFlow my='auto'>
				<Text fw='bold' fz='xl'>With ShapeDivider</Text>
				<Dummy length='l' />
			</Container>
			<ShapeDivider shape='wave2' c='base' />
		</Stack>
	</PreviewArea>
	<PreviewCode>
		```jsx "\<ShapeDivider"
