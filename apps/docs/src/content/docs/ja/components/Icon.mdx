...
import { Container, Grid, Stack, Flex, Callout, Spacer, Cluster, Icon, Center } from '@lism-ui/astro';
...
export const PrestIcons = () => {
	return <Grid variant='tile' itemMinW='10rem' gap='20'>
			{Object.keys(presetIcons).map((iconName) => {
				return (
					<Stack key={iconName} gap='10' ai='c' bgc='base-2' bdrs='xs' p='box' lh='1'>
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Icon as={Cat} exProps={{ weight:'fill', size:'3em' }} c='black' />
	</PreviewArea>
	<PreviewCode>
		```jsx "as=" "exProps="
		<Icon as={Cat} exProps={{ weight:'fill', size:'3em' }} c='black' />
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Flex gap='20'>
			<Icon emoji='✍️' fz='2xl' />
			{/* <Icon variant='emoji' fz='2xl'>✍️</Icon> */}
			<Icon emoji='💡' fz='2xl' />
		</Flex>
	</PreviewArea>
