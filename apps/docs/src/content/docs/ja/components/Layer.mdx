...
import { Media, MediaLayer, Layer, Stack, Alert, Note, Text, Box, Columns, Center, Frame } from '@lism-ui/astro';
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Frame aspect='cinema'>
			...
			<Text pos='a' bottom='0' right='0' p='box:s' c='white' fz='xs' opacity='0.8'>Photo by xxxxxx.</Text>
		</Frame>
		<Frame aspect='cinema'>
			<img src='/img.jpg' alt='' width='960' height='640' />
