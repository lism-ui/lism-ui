...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Frame bgc='base'>
			...
			<Stack hasGutter pos='r' py='50' gap='40' c='white' bgc='black:50%'>
				<DammyText/>
				<DammyText length='l' />
			</Stack>
		</Frame>
	...
	<PreviewCode slot='tab' label='JSX'>
		...
		<Frame bgc='base'>
			<Media isLayer src="/img/img-3.jpg" alt="" width='960' height='640' loading='lazy' decoding='async' />
			<Stack hasGutter pos='r' py='50' gap='40' c='base' bgc='black:50%'>
				<DammyText/>
				<DammyText length='l' />
			</Stack>
		</Frame>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="is--frame -bgc:base">
			...
			<div class="l--stack has--gutter -pos:r -py:50 -c: -bgc: -gap:40" style="--c:var(--white);--bgc:hsl(var(--hsl-black) / 50%)">
