...
<Preview>
	...
	<PreviewArea resize p='30'>
		<LinkBox href='#boxlink01' p='40' bgc='base' bdc='divider' bd bdrs='4'>
			<Text fz='xl' fw='bold'>Heading text</Text>
			<Dummy length='m' c='text-2' lh='s' mbs='20' />
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<a class="is--linkBox -hov:fade -p:40 -bgc:base -bd: -bdc:divider -bdrs:l" href="#boxlink01">
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="is--linkBox -hov:fade -p:40 -bgc:base -bd: -bdc:divider -bdrs:l">
			<p class="-fz:xl -fw:b">
...
<Preview>
	...
	<PreviewArea p='30'>
		<LinkBox href='#boxlink03' setHiddenLink linkLabel='リンクだよ' p='40' bgc='base' bdc='divider' bd bdrs='4'>
			<Text fz='xl' fw='bold'>Heading Text</Text>
			<Dummy length='m' c='text-2' lh='s' mbs='20' />
