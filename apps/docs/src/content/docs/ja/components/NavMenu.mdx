...
| <PropBadge ml='-1px'>`<NavMenuList>`</PropBadge><br/>`provide.p` | 各メニューのpaddingを一括調整できます |
| <PropBadge ml='-1px'>`<NavMenuList>`</PropBadge><br/>`provide.gap` | 各メニューのgapを一括調整できます |
...
<Preview>
	<PreviewTitle>ボックススタイルにしてhovカラー指定, provideでpaddingやgapを一括指定</PreviewTitle>
	<PreviewArea p='40'>
		<NavMenuList hasDivider bd hovBgc='black' hovC='white' provide={{ p: 'em8',gap: 'em6' }}>
			<NavMenu href='#menu1'>
...
<Preview>
	...
	<PreviewArea p='40'>
		<Box minH="20rem">
		<NavMenuList isFlex hasDivider provide={{ p: 'em6 em8' }}>
			<NavMenu href='#menu1'>Menu item</NavMenu>
			<NavMenu hover='pass' pos='r'>
				...
				<NavMenuList hover='get:show' pos='a' top='100%' bgc='base' bxsh='2' bdrs='xs' hasDivider nestLevel={1}>
