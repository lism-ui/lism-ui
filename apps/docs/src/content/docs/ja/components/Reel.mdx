...
import { Reel, Frame, Box, FlexItem, Cluster } from '@loos/lism-core';
...
<Preview>
	...
	<PreviewArea p={20} isShadow={false} isFlow='s'>
		...
		<Cluster gap={20} jc='c' lh='1'>
			<FlexItem tag='a' href='#image-1' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>1</FlexItem>
			<FlexItem tag='a' href='#image-2' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>2</FlexItem>
			<FlexItem tag='a' href='#image-3' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>3</FlexItem>
			<FlexItem tag='a' href='#image-4' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>4</FlexItem>
			<FlexItem tag='a' href='#image-5' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>5</FlexItem>
			<FlexItem tag='a' href='#image-6' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>6</FlexItem>
		</Cluster>
	</PreviewArea>
	<PreviewCode>
		```jsx
