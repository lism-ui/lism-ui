...
import { Box, Dummy, Frame, Spacer, Layer, Media, Tabs, TabItem } from '@lism-ui/astro';
import { Preview, PreviewArea, PreviewTitle, PreviewCode, ImportSource } from "~/components";
import ShapeDivider from '~/components/ex/ShapeDivider/index.jsx';
...
## Import
<ImportSource name='ShapeDivider' css react />
