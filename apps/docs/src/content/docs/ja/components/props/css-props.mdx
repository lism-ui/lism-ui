...
|---|---|---|---|---|
|`c`|`color`|[`COLOR`](/ja/css/tokens/#color)|`main`,`accent`<br />`text`,`text-2`,<br />`base`,<br />`keycol`,`mix`,<br />`inherit`|-|
|`bgc`|`background-color`|[`COLOR`](/ja/css/tokens/#color)|`main`,`accent`<br />`base`,`base-2`,<br />`text`,<br />`keycol`,`mix`,<br />`inherit`|-|
|`bdc`|`--bdc`|[`COLOR`](/ja/css/tokens/#color)|`main`,`accent`<br />`divider`,<br />`keycol`,`mix`,<br />`inherit`,<br />`t`(`transparent`)|-|
|`keycol`|`--keycol`|[`COLOR`](/ja/css/tokens/#color)|-|-|
