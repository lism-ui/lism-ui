...
|---|---|---|---|---|
|`c`|`color`|[`COLOR`](/ja/css/tokens/#color)|`main`,`accent`<br />`text`,`text-2`,<br />`base`,<br />`keycolor`,`mix`,<br />`inherit`|-|
|`bgc`|`background-color`|[`COLOR`](/ja/css/tokens/#color)|`main`,`accent`<br />`base`,`base-2`,<br />`text`,<br />`keycolor`,`mix`,<br />`inherit`|-|
|`bdc`|`--bdc`|[`COLOR`](/ja/css/tokens/#color)|`main`,`accent`<br />`divider`,<br />`keycolor`,`mix`,<br />`inherit`,<br />`t`(`transparent`)|-|
...
|`op`|opacity|[`OPACITY`](/ja/css/tokens/#opacity)|`OPACITY`,`0`||
...
|`bdc`|`--bdc`|`COLOR`,`PALETTE`|`divider`,`i`,`keycolor`|-|
|`bdw`|`--bdw`|-|-|○|
|`bds`|`--bds`|-|-|-|
{/* |`bdl`|`border-left`|-|-|-|
|`bdr`|`border-right`|-|-|-|
