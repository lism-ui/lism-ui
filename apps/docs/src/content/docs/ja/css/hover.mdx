...
<Preview>
	...
	<PreviewArea p='30'>
		<LinkBox layout={Frame} hov='pass' href='#banner-link' aspect='16/9' bdrs='4'>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<a class="l--frame is--linkBox -hov:pass -aspect:16/9 -bdrs:4" href="#banner-link">
...
<Preview>
	...
	<PreviewArea p='30'>
		<LinkBox href='#banner-link' ov='h' aspect='16/9' hov='pass' bdrs='4'>
			<Frame isLayer>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<a class="is--linkBox -hov:pass -aspect:16/9 -ov:h -bdrs:4" href="#banner-link">
