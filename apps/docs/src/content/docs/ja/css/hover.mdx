...
<Preview>
	...
	<PreviewArea p='30'>
		<LinkBox isFrame hov='pass' href='#banner-link' aspect='16/9' bdrs='4'>
			<Media isLayer src='/img/img-1.jpg' alt='' width='960' height='640' loading='lazy' />
			<Badge variant='fill' hov='get:hide' pos='a' r='0' m='20' bdrs='99'>Some Text</Badge>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<a class="is--frame is--linkBox -hov:pass -aspect:16/9 -bdrs:4" href="#banner-link">
			...
			<div class="l--center -hov:get:show -pos:a -inset:0">
				<span class="-c:white -bgc:black -bdrs:99 -px:30 -py:10">View More</span>
			</div>
		</a>
		```
	</PreviewCode>
...
<Preview>
	...
	<PreviewArea p='30'>
		<LinkBox isFrame href='#banner-link' aspect='16/9' hov='pass' bdrs='4'>
