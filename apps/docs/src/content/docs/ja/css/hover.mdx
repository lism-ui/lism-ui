...
さらに、親要素で`--trsdu--default`を上書きして子要素のトランジション時間を一括で変更してみます。
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html "-hov:pass" "-hov:get:zoom" "-hov:get:letterSpread" "--trsdu--default"
		<a
			href="#banner-link"
			class="is--linkBox -hov:pass -ar:16/9 -ov:h -bdrs:4"
			style="--trsdu--default:.6s"
		>
	...
	<PreviewCode slot='tab' label='JSX'>
		```jsx "hov='pass'" "hov='get:zoom'" "hov='get:letterSpread'" "--trsdu--default"
		<LinkBox
			href='#banner-link'
			hov='pass' ov='h' ar='16/9' bdrs='4'
			style={{'--trsdu--default':'.6s'}}
