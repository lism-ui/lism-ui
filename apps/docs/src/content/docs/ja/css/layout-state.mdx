...
<Preview>
	<PreviewTitle>例</PreviewTitle>
	<PreviewArea p='10'>
	<Media src='/img/img-3.jpg' alt='' aspect='2/1' width='960' height='640' loading='lazy' hasMask='<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#FF0066" d="M170.4,25.7c16.1,14.2,23.2,38.5,24.8,61.7c1.7,23.3-1.8,45.5-12.9,62.3c-11,16.9-29.3,28.6-48.8,34.5 c-19.4,5.9-40,6.1-59.5,0.4c-19.5-5.6-37.9-17.4-51.7-34.9c-14-17.5-23.2-40.8-18-60.2c5-19.4,24.5-34.7,43.5-48.4 s37.6-25.7,59.5-29.7C129.1,7.3,154.2,11.4,170.4,25.7z" /></svg>' />
	</PreviewArea>
	<PreviewCode slot='tab' label='JSX'>
		```jsx
		<Media src='/img/img-3.jpg' alt='' aspect='2/1' width='960' height='640' loading='lazy' hasMask='<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#FF0066" d="M170.4,25.7c16.1,14.2,23.2,38.5,24.8,61.7c1.7,23.3-1.8,45.5-12.9,62.3c-11,16.9-29.3,28.6-48.8,34.5 c-19.4,5.9-40,6.1-59.5,0.4c-19.5-5.6-37.9-17.4-51.7-34.9c-14-17.5-23.2-40.8-18-60.2c5-19.4,24.5-34.7,43.5-48.4 s37.6-25.7,59.5-29.7C129.1,7.3,154.2,11.4,170.4,25.7z" /></svg>' />
...
<Preview>
	<PreviewTitle>`has--delimiter`</PreviewTitle>
	<PreviewArea p='20'>
		<Flex variant='cluster' hasDelimiter>
			<span>Content</span>
			<span>Content</span>
			<span>Content</span>
		</Flex>
...
<Preview>
	...
	<PreviewArea p='20'>
		<Flex variant='cluster' hasDelimiter='>>' gap='20' style={{'--delimiter-c': 'var(--blue)'}}>
