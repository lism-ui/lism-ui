...
import { Lism, Flex, Divider, Stack, Box, Decorator } from "@lism-ui/core";
...
<Preview>
	...
	<div
		...
		style="--pass-p:var(--s--20) var(--s--30);--pass-minW:5rem"
	>
...
<Preview>
	...
	<div
		...
		style="--pass-p:var(--s--5) var(--s--20);--pass-minW:2.5rem"
	>
...
<script src="https://emgithub.com/embed-v2.js?target=https%3A%2F%2Fgithub.com%2Flism-ui%2Flism-ui%2Fblob%2Fmain%2Fpackages%2Flism-core%2Fsrc%2Fscss%2Futility%2F_pass-get.scss&style=default&type=code&showLineNumbers=on&showFileMeta=on&showCopy=on"></script>
