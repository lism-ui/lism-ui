...
<Preview>
	...
	<PreviewArea p='40'>
		<Columns cols={[3, 6]} g='40'>
			<Center aspect='1/1' bdrs='1' bd h='100%' ff='mono' fz='xs' c='text-2'>1</Center>
			<Center aspect='1/1' bdrs='2' bd h='100%' ff='mono' fz='xs' c='text-2'>2</Center>
			<Center aspect='1/1' bdrs='3' bd h='100%' ff='mono' fz='xs' c='text-2'>3</Center>
			<Center aspect='1/1' bdrs='4' bd h='100%' ff='mono' fz='xs' c='text-2'>4</Center>
			<Center aspect='1/1' bdrs='5' bd h='100%' ff='mono' fz='xs' c='text-2'>5</Center>
			<Center aspect='1/1' bdrs='99' bd h='100%' ff='mono' fz='xs' c='text-2'>99</Center>
		</Columns>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```jsx
