...
|トークン名|変数|クラス|
|---|---|---|
|<ColorBadge color='base' />|`--c--base`|`.-c:base`,<br/>`.-bgc:base`|
|<ColorBadge color='base-2' />|`--c--base-2`|`.-bgc:base-2`|
|<ColorBadge color='text' />|`--c--text`|`.-c:text`,<br/>`.-bgc:text`|
|<ColorBadge color='text-2' />|`--c--text-2`|`.-c:text-2`|
|<ColorBadge color='main' />|`--c--main`|`.-c:main`,<br/>`.-bgc:main`|
|<ColorBadge color='accent' />|`--c--accent`|`.-c:accent`,<br/>`.-bgc:accent`|

<Preview>
	<PreviewTitle>使用例</PreviewTitle>
	<PreviewArea p={20}>
		<Box bgc='base-2' bd bdc='divider' p='30'>
			<DammyText />
		</Box>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="l--box -bgc:base-2 -bd: -bdc:divider -p:30">...</div>
		<div class="l--box -bgc:text -c:base -p:30">...</div>
		```
	</PreviewCode>
	<PreviewCode slot='tab' label='JSX'>
		```jsx
		<Box bgc='base-2' bd bdc='divider' p='30'>...</Box>
		<Box bgc='text' c='base' p='30'>...</Box>
		```
	</PreviewCode>
...
black,white のみ、`c`,`bgc`用のユーティリティクラスも用意しています。

<Preview>
	<PreviewTitle>使用例</PreviewTitle>
	<PreviewArea p={20}>
		<Box c='blue' bgc='blue:15%' p='30'><DammyText /></Box>
		<Box c='white' bgc='black' p='30'><DammyText /></Box>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div class="l--box -c: -bgc:mix -p:30" style="--c:var(--blue);--bgc1:var(--blue);--bgc1-per:15%">...</div>
		<div class="l--box -c:white -bgc:black -p:30">...</div>
		```
	</PreviewCode>
	<PreviewCode slot='tab' label='JSX'>
		```jsx
...
<Preview>
	<PreviewTitle>使用例</PreviewTitle>
	<PreviewArea p={20}>
		<Box keycolor='green' p='30'><DammyText /></Box>
		<Box keycolor='blue' bd p='30'><DammyText /></Box>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```html
...
{/* <Preview>
	<PreviewTitle>使用例</PreviewTitle>
	<PreviewArea p={20}>
		<Box bgc='black:40%' c='white' p='30'><DammyText /></Box>
		<Box bgc='green:10%' c='blue:75%' p='30'><DammyText /></Box>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div
