...
import { Lism, Box, Text, Stack, Flex, Columns, Frame, Callout, Note, Tabs, TabItem, Spacer } from '@lism-ui/astro';
...
|`emoji`|`--ff--emoji`|-|<small>`'Apple Color Emoji', 'Segoe UI Emoji', 'Android Emoji','Segoe UI Symbol'`</small>|
...
|トークン値|変数|クラス|
|---|---|---|
|`s`|`--contentSize--s`|`.-contentSize:s`|
|`m`|`--contentSize--m`|`.-contentSize:m`|
|`l`|`--contentSize--l`|`.-contentSize:l`|
...
<Preview>
	<PreviewTitle>-bdrsクラス</PreviewTitle>
