...
<Preview>
	<PreviewTitle>使用例</PreviewTitle>
	<PreviewArea p={20}>
		<Box boxcolor='green' p='30'><DammyText /></Box>
		<Box boxcolor='blue' bd p='30'><DammyText /></Box>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```html
	...
	<PreviewCode slot='tab' label='JSX'>
		```jsx
		<Box boxcolor='green' p='30'>...</Box>
		<Box boxcolor='blue' bd p='30'>...</Box>
		```
	</PreviewCode>
</Preview>

<Reference>
	[boxcolorについて詳しくはこちら→](/ja/styles/boxcolor/)
</Reference>
