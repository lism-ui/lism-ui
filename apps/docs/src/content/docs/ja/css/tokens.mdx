...
import { Lism, Dummy, Box, Text, Stack, Flex, Columns, Frame, Callout, Center, Tabs, TabItem } from '@lism-ui/astro';
import { FzDemos, SpacingDemos, BoxShadowDemos, RadiusDemos } from "~/mdx/tokens.jsx";

export const ColorBadge = ({color, label}) => {
	return <span className='-d:f -ai:c -g:10'>
			<Lism skipState tag='span' w='1.5em' aspect='1/1' bgc={color} bdrs='2' bxsh='1' />
...
<Preview>
	...
	<PreviewArea p={50} nogrid>
		<Columns cols={[3, 6]} g='40'>
			<Frame aspect='1/1' bdrs='1' bd>
				<Center h='100%' ff='mono' fz='xs' c='text-2'>1</Center>
			</Frame>
			<Frame aspect='1/1' bdrs='2' bd>
				<Center h='100%' ff='mono' fz='xs' c='text-2'>2</Center>
			</Frame>
			<Frame aspect='1/1' bdrs='3' bd>
				<Center h='100%' ff='mono' fz='xs' c='text-2'>3</Center>
			</Frame>
			<Frame aspect='1/1' bdrs='4' bd>
				<Center h='100%' ff='mono' fz='xs' c='text-2'>4</Center>
			</Frame>
			<Frame aspect='1/1' bdrs='5' bd>
				<Center h='100%' ff='mono' fz='xs' c='text-2'>5</Center>
			</Frame>
			<Frame aspect='1/1' bdrs='99' bd>
				<Center h='100%' ff='mono' fz='xs' c='text-2'>99</Center>
			</Frame>
		</Columns>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
