...
<Preview>
	...
	<PreviewArea resize p='30'>
		...
		<Lism className='u--colbox' keycol='#688f04' bd='is' bdc='keycol' bdw='4px' p='30'><Dummy length='codes' /></Lism>
	</PreviewArea>
	<PreviewCode slot="tab" label="HTML">
		```html
		<div class='u--colbox -p:30' style='--keycol:var(--blue)'>...</div>
		<div class='u--colbox -bd: -p:30' style='--keycol:var(--red)'>...</div>
		<div class='u--colbox -bd:is -bdc:keycol -p:30' style='--keycol:#688f04;--bdw:4px'>...</div>
		```
	</PreviewCode>
