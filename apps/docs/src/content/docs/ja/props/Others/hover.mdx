...
import { Alert, Flex, Button, Media, Layer, Text, Box, Stack, Frame, LinkBox, Columns, Banner } from "@lism-ui/core";
...
<Preview>
	...
	<PreviewArea p={20}>
		<LinkBox isFrame hover='pass' href='#banner-link' aspect='16/9' bdrs='l'>
			...
			<Layer hover='get:show' bgc='black:20%' blur='4px'/>
			<Layer hover='get:show' inset='c' c='white' bgc='black:50%' bdrs='l'>
...
<Preview>
	...
	<PreviewArea p={20}>
		<LinkBox isFrame href='#banner-link' aspect='16/9' hover='pass' bdrs='l'>
			<Layer hover='get:zoom' src='/img/img-2.jpg' alt='' width='960' height='640' loading='lazy'/>
		</LinkBox>
	</PreviewArea>
	<PreviewCode slot='tab' label='Component'>
