...
sidebar:
  order: 3
---
import { Lism, Text, Box, Grid } from "@lism-ui/astro";
...
|`insets.is`|`inset-inline-start`|`SPACE`|`0`|-|
|`insets.ie`|`inset-inline-end`|`SPACE`|`0`|-|
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="l--box -pos:r -p:40 -bgc:base-2">
			...
			<div class="l--box -pos:a -t:0 -px:20 -bd:" style="left:2em">
				<p>Absolute Content</p>
			</div>
...
<Preview>
	...
	<PreviewArea resize p='5'>
		<Box pos='r' aspect='3/2' lh='1' ff='mono'>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div class="l--box -pos:r -aspect:3/2 -lh:1 -ff:mono">
