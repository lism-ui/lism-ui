...
|---|---|---|---|---|
|`c`|`color`|`COLOR`|`text`,`text-2`,`base`,`boxcolor`|-|
|`bgc`|`background-color`|`COLOR`|`base`,`base-2`,`text`,`i`,`boxcolor`|-|
|`bdc`|`border-color`|`COLOR`|`divider`,`i`,`boxcolor`|-|
|`boxcolor`|`--boxcolor`|`COLOR`|`COLOR.PALETTE`|-|
