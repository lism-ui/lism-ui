...
|`top`|`top`|`SPACE`|`0`,`50`,`100`|-|
|`left`|`left`|`SPACE`|`0`,`50`,`100`|-|
|`right`|`right`|`SPACE`|`0`,`50`,`100`|-|
|`bottom`|`bottom`|`SPACE`|`0`,`50`,`100`|-|
|`z`|`z-index`|-|`-1`, `0`, `1`|-|
...
|---|---|---|---|
|`gd`|`grid`|-|-|
|`gt`|`grid-template`|`side:s`, `side:e`, `side:l`, `side:r`|○|
...
```jsx
<Lism d='grid' grid={{gtc:'1fr 1fr', gap:40, ai:'center'}}>...</Lism>
```
...
<Grid gtc='1fr 1fr' gap={40} ai='center'>...</Grid>
```
...
|Prop|CSS|To Class|BP|
|---|---|---|---|
|`ga`|`grid-area`|`side`,`start`(`s`),`end`(`e`),`center`(`c`)|-|
|`gc`|`grid-column`|`1`,`2`,`3`, `span2`|○|
|`gr`|`grid-row`|`1`,`2`,`3`, `span2`|○|
