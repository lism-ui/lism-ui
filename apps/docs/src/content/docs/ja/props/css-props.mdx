...
sidebar:
  order: 3
---
import { Lism, Text, Dummy, Box, Grid } from "@lism-ui/astro";
...
|---|---|---|---|---|
|c|`color`|[`COLOR`](/ja/css/tokens/#color)|`text`,`text-2`,`base`,`keycolor`,`mix`,<br />`white`,`black`,<br />`i`(`inherit`)|-|
|bgc|`background-color`|[`COLOR`](/ja/css/tokens/#color)|`base`,`base-2`,`text`,`keycolor`,`mix`,<br />`white`,`black`,<br />`i`(`inherit`)|-|
|bdc|`--bdc`|[`COLOR`](/ja/css/tokens/#color)|`divider`,`keycolor`,`mix`,<br />`i`(`inherit`)|-|
