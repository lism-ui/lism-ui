...
import { Box, Callout, Flex, FlexItem, Stack, Divider, Spacer } from '@lism-ui/astro';
...
<Preview>
	...
	<PreviewArea resize p='40'>
		<Box bd='l,b' bdc='red' p='10'>left, bottom</Box>
	</PreviewArea>
	<PreviewCode label='JSX' slot='tab'>
		```jsx "bd='l,b'"
		<Box bd='l,b' bdc='red' p='10'>left, bottom</Box>
	...
	<PreviewCode label='HTML' slot='tab'>
		```html
		<div class='-bd:l -bd:b -p:10' style="--bdc:var(--red)">left, bottom</div>
		```
	</PreviewCode>
</Preview>
...
<Preview>
	...
	<PreviewArea p='40' resize>
		<Flex fxd={['column','row']} bd bdc='blue'>
			<FlexItem fx='1' bd bdw={['0 0 1px 0','0 1px 0 0']} bdc='i' p='20'>
				Box
			</FlexItem>
			<FlexItem fx='1' bd bdw={['0 0 1px 0','0 1px 0 0']} bdc='i' p='20'>
				Box
