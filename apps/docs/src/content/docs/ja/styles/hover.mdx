...
<Preview>
	...
	<a class="is--frame is--linkBox -hov:pass -aspect:16/9 -bdrs:l" href="#banner-link">
		...
		<div class="is--layer -hov:get:show -inset:c -c: -bgc: -bdrs:l" style="--c:var(--white);--bgc:hsl(var(--hsl-black) / 50%)">
...
<Preview>
	...
	<a class="c--banner is--frame -hov:pass -aspect:16/9 -bdrs:l" href="#banner-link">
		<img class="is--layer-hov:get:zoom -obf:cv" loading="lazy" decoding="async" src="/img/img-2.jpg" width="960" height="640">
	</a>
	```
	</PreviewCode>
</Preview>
